...
#ifdef BODY_CLASS
// clang-format off
BodyStyle(rounded/polyhedron/agent,BodyRoundedPolyhedronAgent);
// clang-format on
#else

#ifndef LMP_BODY_ROUNDED_POLYHEDRON_AGENT_H
#define LMP_BODY_ROUNDED_POLYHEDRON_AGENT_H
...
class BodyRoundedPolyhedronAgent : public Body {
 public:
  BodyRoundedPolyhedronAgent(class LAMMPS *, int, char **);
  ~BodyRoundedPolyhedronAgent() override;
