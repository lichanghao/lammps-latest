...
#include "bond_harmonic_shift_cut_agent.h"
...
BondHarmonicShiftCutAgent::BondHarmonicShiftCutAgent(LAMMPS *lmp) : Bond(lmp)
{
...
BondHarmonicShiftCutAgent::~BondHarmonicShiftCutAgent()
{
  if (allocated) {
...
void BondHarmonicShiftCutAgent::compute(int eflag, int vflag)
{
  int i1,i2,n,type;
...
void BondHarmonicShiftCutAgent::allocate()
{
  allocated = 1;
...
void BondHarmonicShiftCutAgent::coeff(int narg, char **arg)
{
...
double BondHarmonicShiftCutAgent::equilibrium_distance(int i)
{
  return r0[i];
}
...
void BondHarmonicShiftCutAgent::write_restart(FILE *fp)
{
...
void BondHarmonicShiftCutAgent::read_restart(FILE *fp)
{
  allocate();
...
void BondHarmonicShiftCutAgent::write_data(FILE *fp)
{
...
double BondHarmonicShiftCutAgent::single(int type, double rsq, int /*i*/, int /*j*/,
                                    double &fforce)
{
  fforce = 0.0;
  double r = sqrt(rsq);
...
void BondHarmonicShiftCutAgent::born_matrix(int type, double rsq, int /*i*/, int /*j*/, double &du, double &du2)
{
  du = 0.0;
  du2 = 0.0;
